...
class _SubscriptionPageState extends State<SubscriptionPage> {
  ...
  Widget _buildPremiumPackage(BuildContext context) {
    ...
    return PackageCardWidget(
      ...
      features: const ['Mở khóa toàn bộ từ vựng & bài học HSK 1-6', 'Thi thử HSK không giới hạn', 'Không có quảng cáo'],
  ...
  Widget _buildStandardPackage(BuildContext context) {
    ...
    return PackageCardWidget(
      ...
      features: const ['Học từ vựng HSK 1-3', 'Lưu trữ tiến độ học tập'],
